...
def schedule(request, pk):
    ...
    com12_1, com12_2, com12_3, com12_4, com12_5, com12_6, com12_7, com12_8, com12_9, com12_10, com12_11, com12_12 = [], [], [], [], [], [], [], [], [], [], [], []
    ...
    match count_tour:
        case 12:
            ...
            empty_com_1 = []
            empty_com_2 = []
            for i in range(0, len(com_d[11]) - 1, 2):
                if com_d[11][i + 1] not in commands_dict[com_d[11][i]]:
                    com12_1.append([com_d[11][i], com_d[11][i + 1]])
                else:
                    empty_com_1.append(com_d[11][i])
                    empty_com_2.append(com_d[11][i + 1])

            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_1.append((empty_com_1[i], c))
            ...
            for i in range(0, len(com_d[10]) - 1, 2):
                if com_d[10][i + 1] not in commands_dict[com_d[10][i]]:
                    com12_2.append([com_d[10][i], com_d[10][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_2.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[9]) - 1, 2):
                if com_d[9][i + 1] not in commands_dict[com_d[9][i]]:
                    com12_3.append([com_d[9][i], com_d[9][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_3.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[8]) - 1, 2):
                if com_d[8][i + 1] not in commands_dict[com_d[8][i]]:
                    com12_4.append([com_d[8][i], com_d[8][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_4.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[7]) - 1, 2):
                if com_d[7][i + 1] not in commands_dict[com_d[7][i]]:
                    com12_5.append([com_d[7][i], com_d[7][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_5.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[6]) - 1, 2):
                if com_d[6][i + 1] not in commands_dict[com_d[6][i]]:
                    com12_6.append([com_d[6][i], com_d[6][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_6.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[5]) - 1, 2):
                if com_d[5][i + 1] not in commands_dict[com_d[5][i]]:
                    com12_7.append([com_d[5][i], com_d[5][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_7.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[4]) - 1, 2):
                if com_d[4][i + 1] not in commands_dict[com_d[4][i]]:
                    com12_8.append([com_d[4][i], com_d[4][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_8.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[3]) - 1, 2):
                if com_d[3][i + 1] not in commands_dict[com_d[3][i]]:
                    com12_9.append([com_d[3][i], com_d[3][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_9.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[2]) - 1, 2):
                if com_d[2][i + 1] not in commands_dict[com_d[2][i]]:
                    com12_10.append([com_d[2][i], com_d[2][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_10.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[1]) - 1, 2):
                if com_d[1][i + 1] not in commands_dict[com_d[1][i]]:
                    com12_11.append([com_d[1][i], com_d[1][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_11.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break
            ...
            for i in range(0, len(com_d[0]) - 1, 2):
                if com_d[0][i + 1] not in commands_dict[com_d[0][i]]:
                    com12_12.append([com_d[0][i], com_d[0][i + 1]])
                else:
            ...
            for i in range(0, len(empty_com_1)):
                for c in empty_com_2:
                    if c not in empty_com_1[i]:
                        com12_12.append((empty_com_1[i], c))
                        empty_com_2.remove(c)
                        break

            if len(com_d[0]) % 2 != 0:
                com12_12.append([com_d[0][-1], "Пустышка"])

            if len(com_d[1]) % 2 != 0:
                com12_11.append([com_d[1][-1], "Пустышка"])

            if len(com_d[2]) % 2 != 0:
                com12_10.append([com_d[2][-1], "Пустышка"])

            if len(com_d[3]) % 2 != 0:
                com12_9.append([com_d[3][-1], "Пустышка"])

            if len(com_d[4]) % 2 != 0:
                com12_8.append([com_d[4][-1], "Пустышка"])

            if len(com_d[5]) % 2 != 0:
                com12_7.append([com_d[5][-1], "Пустышка"])

            if len(com_d[6]) % 2 != 0:
                com12_6.append([com_d[6][-1], "Пустышка"])

            if len(com_d[7]) % 2 != 0:
                com12_5.append([com_d[7][-1], "Пустышка"])

            if len(com_d[8]) % 2 != 0:
                com12_4.append([com_d[8][-1], "Пустышка"])

            if len(com_d[9]) % 2 != 0:
                com12_3.append([com_d[9][-1], "Пустышка"])

            if len(com_d[10]) % 2 != 0:
                com12_2.append([com_d[10][-1], "Пустышка"])

            if len(com_d[11]) % 2 != 0:
                com12_1.append([com_d[11][-1], "Пустышка"])

            file = open(f"{posts[0].title}/{posts[0].title}_тур12.txt", "r", encoding="utf-8")
            if len(file.read()) == 0:
                file = open(f"{posts[0].title}/{posts[0].title}_тур12.txt", "w", encoding="utf-8")
                num = 1
            ...
            file_res = open(f"{posts[0].title}/результат_12_{posts[0].title}.txt", "r", encoding="utf-8")
            file_res.seek(0)
            com_d = {}
            for i in range(0, 13):
                com_d[i] = []
            ...
            return render(request, 'blog/sсhedule.html',
                          {'title': 'Орда', 'name': posts[0].title, 'count_tour': int(count_tour),
                           ...
                           'tour12_1': com12_1, 'tour12_2': com12_2, 'tour12_3': com12_3, 'tour12_4': com12_4,
                           'tour12_5': com12_5,
                           'tour12_6': com12_6, 'tour12_7': com12_7, 'tour12_8': com12_8, 'tour12_9': com12_9,
                           'tour12_10': com12_10, 'tour12_11': com12_11, 'tour12_12': com12_12})
        ...
        case 6:
            ...
            if len(com_d[1]) % 2 != 0:
                com6_5.append([com_d[1][-1], "Пустышка"])

            if len(com_d[2]) % 2 != 0:
                com6_4.append([com_d[2][-1], "Пустышка"])

            if len(com_d[3]) % 2 != 0:
                com6_3.append([com_d[3][-1], "Пустышка"])

            if len(com_d[4]) % 2 != 0:
                com6_2.append([com_d[4][-1], "Пустышка"])
...
def save_tour_1(request):
    if request.method == 'GET':
        ...
        # заполнение 1ого тура со счётом
...
def tour_shedule(game, tour):
    ...
    if game.split()[1] in ["МСКЛ", "Восток", "Запад"]:
        ...
        base_img.save(f'{game}/tour_shedule_{tour}.png', quality=100)
        ...
        for i in range(1, count_photo + 1):
            base_img_copy = Image.open(f'{game}/tour_shedule_{tour}.png')
            drawer = ImageDraw.Draw(base_img_copy)
            for _ in range(5):
                line = file.readline()
                team_1 = line[:45].strip()
